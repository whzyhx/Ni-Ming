...
let changelog = `<h1>计算公式:</h1><br><h3>
			...
			<br>
			<h1>更新日志<br></h1>
			<br><h3>v0.2.1<br></h3><br>
			<h1>对整个游戏进行了一次优化,游戏变得更加流畅</h1><br><br>
			- 增加VIP6<br>
			- 增加回收黄金装备<br>
			- 增加回收龙纹甲<br>
			- 增加这个游戏的第十八只怪物—————祖玛神殿-中级杂魔兵!!!<br>
			- 增加这个游戏的第十九只怪物—————祖玛神殿-祖玛刀兵!!!<br>
			- 增加这个游戏的第二十只怪物—————祖玛神殿-祖玛弓兵!!!<br>
			- 增加这个游戏的第二十一只怪物—————祖玛神殿-祖玛斧兵!!!<br>
			- 增加这个游戏的第二十二只怪物—————祖玛神殿-祖玛枪兵!!!<br>
			- 增加这个游戏的第二十三只怪物—————祖玛神殿-祖玛小队!!!<br>
			- 增加圣器-头盔<br>
			- 增加圣器-衣服<br>
			- 增加圣器-裤子<br>
			- 增加圣器-靴子<br>
			- 修复一些奇怪的显示问题<br>
			<br><h3>v0.2.0-1<br></h3>
			- 修复无限刷圣器的BUG<br>
			<br><h3>v0.2.0<br></h3>
			- 修复自动转化魔血的数值问题<br>
			- 增加修为系统(开放至分神10阶)<br>
			- 修改战力里程碑(100W战力),从魔血结晶需求/2=>魔血需求开2次根<br>
			- 增加自动挂机-巢穴-黄金巨人<br>
			- 增加自动挂机-祖玛神殿-祖玛守卫<br>
			- 为了优化游戏,在你获得了全部资源后将不再显示秘境<br>
			<br><h3>v0.1.9<br></h3>
			- 翅膀上限开放至39级<br>
